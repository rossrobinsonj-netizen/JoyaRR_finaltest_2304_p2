# JoyaRR_finaltest_2304_p2
Joya RR, This is the Version control for the final test.


Joya Ross-Robinson: Here are the instructions for the final test respitory. 


## Purpose
This repository is used to demonstrate version control, issue tracking,
...
- AboutPage.html  
  This AboutPage.html is used for python code for the web app.
